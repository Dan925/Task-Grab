...
function stringAvatar(user, addColor) {
  return {
    ...
    children: `${user.first_name.toUpperCase()[0]}${
  ...
  return (
    <div className="navbar" ref={ref}>
      <div style={{ display: "flex", gap: "2em", alignItems: "center" }}>
          ...
          <Box>
            ...
            >
              ...
              >
                ...
                {state.isLoggedIn && (
                  <ListItem>
                    <NavLink activeClassName="active" to="/create-task">
                      {t("navbar.link2")}
                    </NavLink>
                  </ListItem>
                )}
                {state.isLoggedIn && (
                  <ListItem>
                    <NavLink activeClassName="active" to="/create-group">
                      Create Group
                    </NavLink>
                  </ListItem>
                )}
                {state.isLoggedIn && (
                  <ListItem>
                    <NavLink activeClassName="active" to="/invite-user">
                      Invite User
                    </NavLink>
                  </ListItem>
                )}
        ...
        <Link id="logo-link" to="/dashboard">
